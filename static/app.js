...
const LANGUAGES = [
  ...
  {"code":"pol","label":"PL","name":"Polski","desc":"Polish"},
  {"code":"hun","label":"HU","name":"Magyar","desc":"Hungarian"},
  {"code":"pes","label":"FA","name":"فارسی","desc":"Persian"}
];
...
const TRANSLATIONS = {
    ...
    "rus": {
        ...
        "connectionError": "Соединение потеряно. Повтор через {0}с...",
    ...
    "pol": {
        "waitingForTranslation": "Czekam na tłumaczenie...",
        "switchingLanguage": "Przełączam język...",
        "connecting": "Łączenie...",
        "live": "LIVE",
        ...
        "subtitleCount": "Liczba napisów",
        "showQrCode": "Pokaż kod QR",
        "qrPageTitle": "Tłumaczenie na żywo",
        "qrInstruction": "Połącz się z Wi-Fi i zeskanuj kod",
        "pageTitle": "Tłumaczenie na żywo",
        "offline": "Tryb offline",
        "updateAvailable": "Dostępna nowa wersja",
        "updateReload": "Odśwież"
    },
    "hun": {
        "waitingForTranslation": "Fordításra várok...",
        "switchingLanguage": "Nyelvváltás...",
        "connecting": "Kapcsolódás...",
        "live": "ÉLŐ",
        "disconnected": "Megszakadt a kapcsolat",
        "disconnectedTimer": "Megszakadt ({0}s)",
        "connectionError": "A kapcsolat megszakadt. Újracsatlakozás {0} mp múlva...",
        "selectLanguage": "Nyelv kiválasztása",
        "close": "Bezárás",
        "settings": "Beállítások",
        "fontSize": "Betűméret",
        "showTimestamps": "Időbélyegek megjelenítése",
        "subtitleCount": "Feliratok száma",
        "showQrCode": "QR-kód megjelenítése",
        "qrPageTitle": "Élő fordítás",
        "qrInstruction": "Csatlakozás Wi-Fi-hez és a kód beolvasása",
        "pageTitle": "Élő fordítás",
        "offline": "Offline mód",
    ...
    "pes": {
        ...
        "showTimestamps": "نمایش مهرهای زمانی",
        "subtitleCount": "تعداد زیرنویس",
        "showQrCode": "نمایش کد QR",
        "qrPageTitle": "ترجمه زنده",
        "qrInstruction": "اتصال به Wi-Fi و اسکن کد",
        "pageTitle": "ترجمه زنده",
        "offline": "حالت آفلاین",
        "updateAvailable": "نسخه جدید موجود است",
        "updateReload": "بارگیری مجدد"
    }
};
